...
//Verify if user can View Locations-State
...
public class FWA_143 {
  ...
  @Test
  public void userCanViewLocationsByState() throws InterruptedException {   
		//Log in user
	    ...
	    //Open to view locations by state
	    driver.findElement(By.xpath("//header/div[2]/div[1]/wo-nav[1]/ul[1]/li[2]/a[1]")).click();
	    Thread.sleep(3000);	
	    driver.findElement(By.tagName("input")).sendKeys("Quebec");
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//li[contains(text(),'Quebec City Area, QC, Canada')]")).click();
	    Thread.sleep(3000);
	    System.out.println("I can view locations by State"); 
  	} 
