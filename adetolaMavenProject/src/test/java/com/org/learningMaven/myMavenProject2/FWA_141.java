...
//Verify if user can View Locations-Store
...
public class FWA_141 {
  ...
  @Test
  public void userCanViewLocationsByStore() throws InterruptedException {   
		//Log in user
	    ...
	    //Open to view locations by store
	    driver.findElement(By.xpath("//header/div[2]/div[1]/wo-nav[1]/ul[1]/li[2]/a[1]")).click();
	    Thread.sleep(3000);	
	    driver.findElement(By.tagName("input")).sendKeys("Freshii, Forest Hill");
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//li[contains(text(),'Freshii - Forest Hill Village, Spadina Road, Toron')]")).click();
	    Thread.sleep(3000);
	    System.out.println("I can view locations by store"); 
  	} 
