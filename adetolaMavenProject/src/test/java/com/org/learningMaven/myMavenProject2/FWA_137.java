...
//Verify the process - Reorder a past order
...
public class FWA_137 {
  ...
  @Test
  public void reorderPastOrder() throws InterruptedException {   
	//Log in user
    ...
    //click on reorder from the list
    driver.findElement(By.xpath("//button[contains(text(),'Reorder')]")).click();
    Thread.sleep(5000);  
    
    /*	For ASAP orders. It doesnt have to be used as it is set to ASAP by default
    	driver.findElement(By.xpath("//button[contains(text(),'ASAP')]")).click();
    */	Thread.sleep(5000);
    ...
    Thread.sleep(5000);
    System.out.println("Reorder of past order is successful!"); 
  	} 
