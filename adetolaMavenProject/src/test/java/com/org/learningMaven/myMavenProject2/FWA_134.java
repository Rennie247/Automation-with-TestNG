...
//Verify whether Referral code is displayed for the user
...
public class FWA_134 {
  ...
  @Test
  public void referralCodeDisplayed() throws InterruptedException {   
	//Log in user
    ...
    //Checking if Referral code is visible
    Boolean ReferralCode = driver.findElement(By.tagName("span")).isDisplayed();
    Thread.sleep(5000);
    System.out.println("Great! Referral Code is visible"); 
  	} 
