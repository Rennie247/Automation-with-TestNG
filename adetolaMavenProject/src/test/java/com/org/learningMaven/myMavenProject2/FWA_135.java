...
//Verify the Referral bonus for the User who referred
...
public class FWA_135 {
  ...
  @Test
  public void referralBonusOfWhoReferred() throws InterruptedException {   
	//Log in user
    ...
    //Select 'Rewards and Offers' from option
    driver.findElement(By.xpath("//span[contains(text(),'REWARDS & OFFERS')]")).click();
    Thread.sleep(5000);
