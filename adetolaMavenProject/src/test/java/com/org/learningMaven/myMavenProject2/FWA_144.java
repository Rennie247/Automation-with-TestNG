...
//Verify if user can View Locations-Pin Address
...
public class FWA_144 {
  ...
  @Test
  public void userCanViewLocationsByPinAddress() throws InterruptedException {   
		//Log in user
	    ...
	    //Open to view locations by Pin Address
	    ...
	    Thread.sleep(3000);
	    System.out.println("I can view locations by Pin Address"); 
  	} 
