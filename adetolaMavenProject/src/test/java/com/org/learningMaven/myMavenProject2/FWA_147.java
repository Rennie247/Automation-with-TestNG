...
public class FWA_147 {
  ...
  @Test
  public void reviewPickUpOrderWhenOffersAreNotAvailable() throws InterruptedException {   
		//Log in user
	    ...
	    System.out.println("The user can Review the PickUp Order when Offers are not available");
