...
//Verify if user can view locations details
...
public class FWA_145 {
  ...
  @Test
  public void userCanViewLocationsDetails() throws InterruptedException {   
		//Log in user
	    ...
	    //Open to view location details
	    driver.findElement(By.xpath("//header/div[2]/div[1]/wo-nav[1]/ul[1]/li[2]/a[1]")).click();
	    Thread.sleep(3000);	
	    driver.findElement(By.tagName("input")).sendKeys("55 Avenue Rd, Toronto, ON, M5R3L2");
	    Thread.sleep(3000);
	    
	    //Select address from the list
	    driver.findElement(By.xpath("//body/app-root[1]/ng-component[1]/div[1]/main[1]/ng-component[1]/ng-"
	    		+ "component[1]/div[1]/div[1]/location-search[1]/autocomplete-manual[1]/div[1]/ul[1]/li[1]")).click();
	    Thread.sleep(3000);
	    
	    //Here is the page for the location details
        driver.findElement(By.xpath("//body/app-root[1]/ng-component[1]/div[1]/main[1]/ng-component[1]/ng-component[1]/div[1]"
        		+ "/div[2]/location-list[1]/article[5]/location-item[1]/div[2]/div[1]/div[1]/button[1]/*[1]")).click();
        Thread.sleep(3000);
	    
	    System.out.println("I can view locations details"); 
  	} 
